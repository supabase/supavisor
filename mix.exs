defmodule Supavisor.MixProject do
  ...
  defp deps do
    [
      ...
      {:ecto_sql, "~> 3.10"},
      {:postgrex,
       github: "elixir-ecto/postgrex",
       ref: "0f92ae39c8f43b6cf39a46ab1142f6fc09be40fe",
       override: true},
      {:phoenix_view, "~> 2.0.2"},
      ...
      {:syn, "~> 3.3"},
      {:pgo, "~> 0.13"},
      {:pg_saslprep, github: "v0idpwn/pg_saslprep", ref: "455e2e50757e8e5e091c00be4c1b9818612e3ca2"},
      {:rustler, "~> 0.36.1"},
