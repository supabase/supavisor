defmodule Supavisor.PeepEscapeIodata do
  @moduledoc """
  ...
  defp do_escape_help(<<?\\, rest::binary>>, acc), do: do_escape_help(rest, [acc, ?\\, ?\\])
  defp do_escape_help(<<?\n, rest::binary>>, acc), do: do_escape_help(rest, [acc, ?\\, ?n])
  defp do_escape_help(<<h, rest::binary>>, acc), do: do_escape_help(rest, [acc, h])
  defp do_escape_help(<<>>, acc), do: acc
