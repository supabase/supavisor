...
defmodule Supavisor.Protocol.WalDecoder.Decoder do
  @moduledoc """
  ...
  alias Supavisor.Protocol.WalDecoder.OidDatabase
  ...
  ## Examples
      ...
      %Supavisor.Protocol.WalDecoder.Decoder.Messages.Insert{relation_id: 24576, tuple_data: {"baz", "560"}}
