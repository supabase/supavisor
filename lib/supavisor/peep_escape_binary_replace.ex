defmodule Supavisor.PeepEscapeBinaryReplace do
  @moduledoc """
  ...
  # defp escape(<<?\\, rest::binary>>, acc), do: escape(rest, [acc, ?\\, ?\\])
  # defp escape(<<?\n, rest::binary>>, acc), do: escape(rest, [acc, ?\\, ?n])
  # defp escape(<<h, rest::binary>>, acc), do: escape(rest, [acc, h])
  ...
  # defp escape_help(<<?\\, rest::binary>>, acc), do: escape_help(rest, [acc, ?\\, ?\\])
  # defp escape_help(<<?\n, rest::binary>>, acc), do: escape_help(rest, [acc, ?\\, ?n])
  # defp escape_help(<<h, rest::binary>>, acc), do: escape_help(rest, [acc, h])
